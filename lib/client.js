  ...
  factory: (require) => {
    ...
    var I18N = {
      zh: {
        ...
        updatedAt: '更新于 ', refreshing: ' · 刷新中', autoRefresh: ' · 每10s自动', loadingHistory: ' · 历史会话加载中 ', estimated: '估算/上报值',
      },
      en: {
        ...
        updatedAt: 'Updated ', refreshing: ' · refreshing', autoRefresh: ' · auto 10s', loadingHistory: ' · loading history ', estimated: 'estimated/reported',
      },
    }
    ...
    function TokenStatsPanel(props) {
      ...
      var refreshInterval = data && data.warming > 0 ? 3000 : 10000
      useEffect(function () {
        refresh()
      ...
      return h('div', { ref: panelRef, className: 'tkn-panel ' + themeClass, style: { left: pos.x, top: pos.y } },
        ...
        h('div', { className: 'tkn-foot' },
          h('span', null, t.updatedAt + fmtDate(data ? data.generatedAt : null) + (loading ? t.refreshing : t.autoRefresh) + (data && data.warming ? t.loadingHistory + data.covered + '/' + (data.covered + data.warming) : '')),
